...
public:
     ...
     * \value AppendTimezoneAbbreviation Append the (translated) timezone abbreviation when timezone information is present
     * \value AppendTimezoneAbbreviationIfNeeded Append the (translated) timezone abbreviation when timezone information is present and differs from the current
     * local timezone.
     *
     * \since 6.15
     */
    enum TimeFormatOption {
        ...
        AppendTimezoneAbbreviation = 0x1,
        AppendTimezoneAbbreviationIfNeeded = 0x2,
    };
