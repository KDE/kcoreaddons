 ...
 * or more subjobs.
 *
 * @deprecated since 6.14, in favor of a new replacement class KCompoundJob.
 *
...
public:
#if KCOREADDONS_ENABLE_DEPRECATED_SINCE(6, 14)
    /**
     * Creates a new KCompositeJob object.
     *
     * @param parent the parent QObject
     */
    KCOREADDONS_DEPRECATED_VERSION(6, 14, "Use KCompoundJob instead")
