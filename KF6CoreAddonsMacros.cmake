...
function(kcoreaddons_target_static_plugins app_target)
    ...
    if(ARGS_NAMESPACE)
        ...
        foreach(PLUGIN_TARGET_NAME IN LISTS KCOREADDONS_STATIC_PLUGINS${SANITIZED_PLUGIN_NAMESPACE})
            if (PLUGIN_TARGET_NAME)
                set(IMPORT_PLUGIN_STATEMENTS "${IMPORT_PLUGIN_STATEMENTS}K_IMPORT_PLUGIN(QStringLiteral(\"${ARGS_NAMESPACE}\"), ${PLUGIN_TARGET_NAME}_factory)\;\n")
    ...
    elseif(ARGS_TARGETS)
        ...
        foreach(ARG_TARGET IN LISTS ARGS_TARGETS)
            ...
            set(IMPORT_PLUGIN_STATEMENTS "${IMPORT_PLUGIN_STATEMENTS}K_IMPORT_PLUGIN(QStringLiteral(\"${PLUGIN_INSTALL_NAMESPACE}\"), ${PLUGIN_NAME}_factory)\;\n")
