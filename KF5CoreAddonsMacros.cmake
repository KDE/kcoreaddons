...
function(kcoreaddons_add_plugin plugin)
    ...
    if (KCA_ADD_PLUGIN_STATIC)
        ...
        if (NOT ${plugin}_factory IN_LIST KCOREADDONS_STATIC_PLUGINS)
            set(KCOREADDONS_STATIC_PLUGINS "${KCOREADDONS_STATIC_PLUGINS};${plugin}_factory" CACHE INTERNAL "list of known static plugins, used to generate Q_IMPORT_PLUGIN macros")
        endif()
    else()
